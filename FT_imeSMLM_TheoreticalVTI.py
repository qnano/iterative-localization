...
# =============================================================================
        for step in range(stepsmax):
            ...
            #kx, ky, kz, modulation contrast, phase shift of sin(omega*x-phi) (maximum at pi/2, minimum at -pi/2), relative intensity
                [kx, 0,  0,  m, phi_plusx[k],   fraction/(itermax*4*(0.5+m/2))], 
                [kx, 0,  0,  m, phi_minusx[k],   fraction/(itermax*4*(0.5+m/2))], 
                [0,  ky, 0,  m, phi_plusy[k],   fraction/(itermax*4*(0.5+m/2))],  
                [0,  ky, 0,  m, phi_minusy[k],   fraction/(itermax*4*(0.5+m/2))], 
            ])
...
#                       Save data
# =============================================================================
saveCRLB = 'FT-VTIxT-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
saveJ = 'FT-JT-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
saveillum = 'FT-modT-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
