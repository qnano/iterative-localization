...
# =============================================================================
        for step in range(stepsmax):
            ...
            #kx, ky, kz, modulation contrast, phase shift of sin(omega*x-phi) (maximum at pi/2, minimum at -pi/2), relative intensity
                [kx, 0,  0,  m, phi_plusx[0,k],   fraction/(itermax*4*(0.5+m/2))], 
                [kx, 0,  0,  m, phi_minusx[0,k],   fraction/(itermax*4*(0.5+m/2))], 
                [0,  ky, 0,  m, phi_plusy[0,k],   fraction/(itermax*4*(0.5+m/2))],  
                [0,  ky, 0,  m, phi_minusy[0,k],   fraction/(itermax*4*(0.5+m/2))], 
            ])
...
# =============================================================================  
        ...
        for step in range(stepsmax):
            ...
            [kx, 0,  0,  m, phi_plusx_id[k],     fraction/(itermax*4*(0.5+m/2))],
            [kx, 0,  0,  m, phi_minusx_id[k],    fraction/(itermax*4*(0.5+m/2))],
            [0,  ky, 0,  m, phi_plusy_id[k],     fraction/(itermax*4*(0.5+m/2))],
            [0,  ky, 0,  m, phi_minusy_id[k],    fraction/(itermax*4*(0.5+m/2))],
            ])
...
# =============================================================================
        ...
        for runs in range(maxruns):
            ...
            mod= np.array([
            #kx, ky, kz, modulation contrast, phase shift of sin(x-phi) (maximum at pi/2, minimum at -pi/2), relative intensity
            [kx, 0,  0,  m, phi_plusx[runs,k],     1/(itermax*4*(0.5+m/2))],
            [kx, 0,  0,  m, phi_minusx[runs,k],    1/(itermax*4*(0.5+m/2))],
            [0,  ky, 0,  m, phi_plusy[runs,k],     1/(itermax*4*(0.5+m/2))],
            [0,  ky, 0,  m, phi_minusy[runs,k],    1/(itermax*4*(0.5+m/2))],
            ])
...
#                       Save data
# =============================================================================
saveCRLB = 'FT-VTIx-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
saveI = 'FT-I-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
saveJ = 'FT-J-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
savethetaMAP = 'FT-thetaMAP-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
savetheta = 'FT-theta-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
savesmp ='FT-smp-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
saveillum = 'FT-mod-iter-' + str(itermax) + '-thetaI-' + str(int(theta[0,2])) + '-m-' + str(int(100*m)) + '-alpha-' + str(int(100*alpha)) + '-thetab-' + str(int(theta[0,3]))
...
np.save(savepath + saveillum, 1/(itermax*4*(0.5+m/2))*I_sum)